...
def test_package_import() -> None:
    ...
    from frequenz.api.common import v1alpha8

    assert v1alpha8 is not None
...
def test_module_import_metrics_bounds() -> None:
    ...
    # pylint: disable=import-outside-toplevel
    from frequenz.api.common.v1alpha8.metrics import bounds_pb2_grpc
...
def test_module_import_metrics_metrics() -> None:
    ...
    # pylint: disable=import-outside-toplevel
    from frequenz.api.common.v1alpha8.metrics import metrics_pb2_grpc
...
def test_module_import_grid() -> None:
    """Test that the modules can be imported."""
    # pylint: disable=import-outside-toplevel
    from frequenz.api.common.v1alpha8 import grid
...
def test_module_import_grid_delivery_area() -> None:
    ...
    # pylint: disable=import-outside-toplevel
    from frequenz.api.common.v1alpha8.grid import delivery_area_pb2_grpc
...
def test_module_import_microgrid() -> None:
    """Test that the modules can be imported."""
    # pylint: disable=import-outside-toplevel
    from frequenz.api.common.v1alpha8 import microgrid
    ...
    # pylint: disable=import-outside-toplevel
    from frequenz.api.common.v1alpha8.microgrid import microgrid_pb2_grpc
...
def test_module_import_microgrid_lifetime() -> None:
    ...
    # pylint: disable=import-outside-toplevel
    from frequenz.api.common.v1alpha8.microgrid import lifetime_pb2_grpc
...
def test_module_import_microgrid_electrical_components() -> None:
    """Test that the modules can be imported."""
    # pylint: disable=import-outside-toplevel
    from frequenz.api.common.v1alpha8.microgrid import electrical_components
...
def test_module_import_microgrid_communication_components() -> None:
    """Test that the modules can be imported."""
    # pylint: disable=import-outside-toplevel
    from frequenz.api.common.v1alpha8.microgrid import communication_components

    assert communication_components is not None

    from frequenz.api.common.v1alpha8.microgrid.communication_components import (
...
def test_module_import_pagination() -> None:
    """Test that the modules can be imported."""
    # pylint: disable=import-outside-toplevel
    from frequenz.api.common.v1alpha8 import pagination
    ...
    # pylint: disable=import-outside-toplevel
    from frequenz.api.common.v1alpha8.pagination import pagination_info_pb2_grpc

    assert pagination_info_pb2_grpc is not None

    # pylint: disable=import-outside-toplevel
    from frequenz.api.common.v1alpha8.pagination import pagination_params_pb2

    assert pagination_params_pb2 is not None

    # pylint: disable=import-outside-toplevel
    from frequenz.api.common.v1alpha8.pagination import pagination_params_pb2_grpc
